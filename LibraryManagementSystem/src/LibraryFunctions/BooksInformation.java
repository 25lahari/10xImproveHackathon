...
public class BooksInformation {
    BookDetails theBooks[] = new BookDetails[50];
    public static int count;

    Scanner input = new Scanner(System.in);

    public int compareBookObjects(BookDetails b1, BookDetails b2) {
    ...
    public BookDetails checkOutBook() {
    ...
    public void checkInBook(BookDetails b) {
        for (int i = 0; i < count; i++) {
